byte0 : ls και cd σε ολόκληρο το τραγούδι των Pokémon (by the way τέλειο) μεχρι να βρω τον φακελο treasure
byte1 : δεν ξερω τι να πω απλα ηταν supercalifragilisticexpialidocious
byte2 : στην αρχη κανεις grep will find shakespeare.txt και αυτο θα κανει την δουλεια του
